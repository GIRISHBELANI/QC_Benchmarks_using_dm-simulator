...
# Use BasicAer dm_simulator by default
...
def submit_circuit(qc, group_id, circuit_id, shots=1, params=None):
...
def invoke_transformer(transformer, circuit, backend=backend, shots=1):
